...
class Tests(unittest.TestCase):
    def setUp(self):
        ...
        self.oligotyping.entropy = os.path.join(my_path, 'files/study.txt')
    ...
    def test_03_EnvironmentFile(self):
        self.assertTrue(files_are_the_same(os.path.join(my_path, 'files/study.txt'),
                                           os.path.join(self.output_directory_path, 'study.txt')))
