...
option_list <- list(
		make_option(c("-o", "--output_file_prefix"), default="unknown",
				help = "Output file prefix [default \"/path/to/input_dir"]"),
		make_option(c("-d", "--distance"), default="horn",
				help = "Distance metric [default \"/path/to/input_dir"]"),
...
parser <- OptionParser(usage = "study.R [options] input_matrix metadata", option_list=option_list,
