...
if __name__ == '__main__':
    ...
    parser.add_argument('oligotypes_across_samples', metavar = 'OLIGOTYPES_ACROSS_DATASETS'/path/to/input_dir
                        help = 'A TAB-delimited matrix file that that contains /path/to/input_dir
                                oligotype frequencies across samples. See the source /path/to/input_dir
                                for an example format')
    parser.add_argument('-c', '--cosine-similarity-threshold', default = 0.1, /path/to/input_dir
                        metavar = 'COS_SIM_THRESHOLD', help = 'The higher the threshold /path/to/input_dir
                                the more oligotypes will be pulled together. Cosine /path/to/input_dir
                                would return 0 for perfectly similar two vectors. Default is %(default)f.')
    parser.add_argument('-o', '--output-file', default = None, metavar = 'OUTPUT_FILE'/path/to/input_dir
    ...
    vis_oligotype_sets_distribution(partitions, vectors, samples, legend = /path/to/input_dir
