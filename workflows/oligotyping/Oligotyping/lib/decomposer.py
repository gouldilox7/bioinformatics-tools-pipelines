...
class Decomposer:
    ...
    def _merge_homopolymer_splits(self, iteration):
        ...
        query, target, output = utils.get_temporary_file_names_for_BLAST_search(prefix = "HPS_%d_" % /path/to/input_dir
    ...
    def _remove_outliers(self, iteration, standby_bin_only = False):
        ...
        if self.no_threading:
            ...
            for i in range(0, len(node_list)):
                ...
                job = 'XO_%s_' % node_id
                query, target, output = utils.get_temporary_file_names_for_BLAST_search(prefix = /path/to/input_dir
                                                                                  directory = self.tmp_directory)
    ...
    def _generate_frequency_curves(self):
        ...
        for i in range(0, len(self.topology.final_nodes)):
            ...
            vis_freq_curve(node.unique_alignment_path, output_file = /path/to/input_dir
    ...
    def _generate_ENVIRONMENT_file(self):
        ...
        environment_file_path = self.generate_output_destination("study.txt")
    ...
    def _store_topology(self):
        ...
        topology_text_file_path = self.generate_output_destination('study.txt')
