...
QUERY_ID, SUBJECT_ID, IDENTITY, /path/to/input_dir
MISMATCHES, GAPS, Q_START, Q_END, S_START, /path/to/input_dir
...
class B6Entry:
    def __init__(self, line = None):
        ...
        if line:
            try:
                self.query_id, self.subject_id, self.identity, /path/to/input_dir
                self.mismatches, self.gaps, self.q_start, self.q_end, /path/to/input_dir
                self.s_end, self.e_value, self.bit_score, self.q_len, self.s_len /path/to/input_dir
