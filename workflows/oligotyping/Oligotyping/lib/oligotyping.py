...
class Oligotyping:
    ...
    def check_input(self):
        ...
        if self.sample_mapping:
            ...
            sample_mapping_new_destination = self.generate_output_destination("study.txt")
    ...
    def check_params(self):
        if self.selected_components:
            ...
            components_declared_more_than_once = [c[0] for c in /path/to/input_dir
                                                                        if len(list(c[1])) > 1]
    ...
    def _contrive_abundant_oligos(self):
        ...
        if self.min_actual_abundance > 0:
            ...
            for i in range(0, len(self.abundant_oligos)):
                ...
                oligo_actual_abundance = sum([self.samples_dict[sample][oligo] for sample in /path/to/input_dir
                                                        if oligo in self.samples_dict[sample]])
        ...
        if self.limit_oligotypes_to:
            ...
            if len(self.abundant_oligos) == 0:
                raise utils.ConfigError("\n\n\t--limit-oligotypes parameter eliminated all /path/to/input_dir
        ...
        for oligo in self.abundant_oligos:
            self.final_oligo_counts_dict[oligo] = sum([self.samples_dict[sample][oligo] for sample in /path/to/input_dir
                                                        if oligo in self.samples_dict[sample]])

        # in case no oligos left
        if not len(self.abundant_oligos):
            raise utils.ConfigError("\n\n\tAll oligotypes were discarded during the noise removal /path/to/input_dir
    ...
    def _generate_MATRIX_files_for_units_across_samples(self):
        ...
        across_samples_MN_file_path = self.generate_output_destination("study.txt")
        across_samples_SN_file_path = self.generate_output_destination("study.txt")
    ...
    def _get_units_across_samples_dicts(self):
        ...
        self.across_samples_sum_normalized, self.across_samples_max_normalized /path/to/input_dir
    ...
    def _generate_ENVIRONMENT_file(self):
        ...
        self.environment_file_path = self.generate_output_destination("study.txt")
        self.progress.update('Being generated')
    ...
    def _generate_MATRIX_files(self):
        ...
        self.matrix_count_file_path = self.generate_output_destination("study.txt")
        self.matrix_percent_file_path = self.generate_output_destination("study.txt")    
    ...
    def _store_read_distribution_table(self):
        ...
        self.read_distribution_table_path = self.generate_output_destination("study.txt")
    ...
    def _generate_random_colors(self):
        ...
        if self.colors_list_file:
            ...
            if len(colors) < len(self.abundant_oligos):
                raise utils.ConfigError("Number of colors defined in colors file /path/to/input_dir
    ...
    def _agglomerate_oligos_based_on_cosine_similarity(self):
        ...
        oligotype_sets_file_path = self.generate_output_destination("study.txt")
    ...
    def _generate_MATRIX_files_for_oligotype_sets(self):
        ...
        counts_file_path = self.generate_output_destination("study.txt")
        percents_file_path = self.generate_output_destination("study.txt")
    ...
    def _generate_oligos_across_samples_figure(self):
        ...
        oligotype_distribution_across_samples(self.samples_dict, self.colors_dict, /path/to/input_dir
    ...
    def _generate_sets_across_samples_figure(self):
        ...
        self.progress.update('Generating')
        vis_oligotype_sets_distribution(self.oligotype_sets, self.across_samples_sum_normalized, /path/to/input_dir
                               display = False, colors_dict = self.colors_dict, output_file = /path/to/input_dir
    ...
    def _generate_stack_bar_figure_with_agglomerated_oligos(self):
        ...
        oligotype_distribution_stack_bar(self.samples_dict_with_agglomerated_oligos, /path/to/input_dir
                                         stack_bar_file_path, oligos = self.oligotype_set_ids, project_title = /path/to/input_dir
