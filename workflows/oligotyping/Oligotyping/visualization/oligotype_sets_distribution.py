...
if __name__ == '__main__':
    ...
    parser.add_argument('environment_file', metavar = 'ENVIRONMENT_FILE'/path/to/input_dir
                        help = 'Environment file')
    parser.add_argument('sets_file', metavar = 'PARTITIONS_FILE'/path/to/input_dir
                        help = 'Serialized list of lists for oligotype sets')
    parser.add_argument('oligotypes_across_samples', metavar = 'OLIGOTYPES_ACROSS_DATASETS'/path/to/input_dir
                        help = 'A TAB-delimited matrix file that contains /path/to/input_dir
                                oligotype frequencies across samples')
    parser.add_argument('--colors-file', metavar = 'COLORS_FILE', default = /path/to/input_dir
                        help = 'File that contains random colors for oligotypes')
    parser.add_argument('--output-file', default = None, metavar = 'OUTPUT_FILE'/path/to/input_dir
                        help = 'File name for the figure to be stored. File /path/to/input_dir
                                must end with "png", "jpg", or "tiff".')
    parser.add_argument('--legend', action = 'store_true', default = False,
                        help = 'Turn on legend')
    parser.add_argument('--project-title', default = None, metavar = 'PROJECT_TITLE'/path/to/input_dir
    ...
    vis_oligotype_sets_distribution(partitions, vectors, samples, colors_dict, output_file = /path/to/input_dir
