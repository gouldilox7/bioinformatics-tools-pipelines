...
if __name__ == '__main__':
    ...
    parser.add_argument('-x', '--x-limit', default = 20, type = int, metavar = 'X_LIMIT'/path/to/input_dir
                        help = 'Number of items to show from frequency list')
    parser.add_argument('--mini', action = 'store_true', default = False,
                        help = 'Generate mini images')
    parser.add_argument('--title', metavar = 'TITLE_TEXT', help = 'Title to appear on top of /path/to/input_dir
                         figure')
