...
def oligotype_distribution_stack_bar(samples_dict, colors_dict, output_file = None, legend = /path/to/input_dir
...
if __name__ == '__main__':
    ...
    parser.add_argument('--color-list-file', metavar = 'COLORS_FILE', default = /path/to/input_dir
